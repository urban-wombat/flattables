# Getting started with `Google FlatBuffers` and `FlatTables`
...
* Table names must be `UpperCamelCase` as per the [FlatBuffers style guide](https://google.github.io/flatbuffers/flatbuffers_guide_writing_schema.html)
...
The `flattablesc` utility is at [flattables/cmd/flattablesc](https://github.com/urban-wombat/flattables/cmd/flattablesc).
