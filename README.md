...
i. Look first at
[https://godoc.org/github.com/urban-wombat//flattables_sample/cmd/flattables_sample/flattables_sample_main.go](https://godoc.org/github.com/urban-wombat//flattables_sample/cmd/flattables_sample/flattables_sample_main.go)
which is a runnable example.

ii. And look second at
...
4. Create your `FlatTables` /data-file - this is a set of `gotables` tables, not a flatbuffers `.fbs` file
	...
	(the `*.fbs` file is auto-generated by flattablesc, not your problem).
